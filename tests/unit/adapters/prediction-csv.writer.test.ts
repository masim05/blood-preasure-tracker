...
import { PredictionCsvFileWriter } from '../../../src/adapters/outbound/filesystem/prediction-csv.writer';
import { PredictedReading } from '../../../src/domain/entities/predicted-reading';
