import type { BearerAccessToken } from '../../src/domain/entities/bearer-access-token';
import type { Measurement } from '../../src/domain/entities/measurement';
import type { MeasurementImage } from '../../src/domain/entities/measurement-image';
import type { RecognitionTask } from '../../src/domain/entities/recognition-task';
import type { UserAccount } from '../../src/domain/entities/user-account';
import type {
  BearerTokenGeneratorPort,
  BearerTokenStorePort,
} from '../../src/application/ports/bearer-token-store.port';
import type {
  MeasurementImageStorePort,
  StoreMeasurementImageInput,
  StoredMeasurementImageData,
} from '../../src/application/ports/measurement-image-store.port';
import type {
  ListMeasurementsFilter,
  MeasurementHistoryPage,
  MeasurementStorePort,
} from '../../src/application/ports/measurement-store.port';
import type { PasswordHasherPort } from '../../src/application/ports/password-hasher.port';
import type { RecognitionTaskStorePort } from '../../src/application/ports/recognition-task-store.port';
import type { UserAccountStorePort } from '../../src/application/ports/user-account-store.port';
import { MeasurementImage as MeasurementImageEntity } from '../../src/domain/entities/measurement-image';
