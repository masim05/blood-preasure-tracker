...
import { FilesystemMeasurementImageStorageAdapter } from './measurement-image-storage.adapter';
import type { PostgresPool } from '../postgres/postgres-pool';
import type { ApiConfigService } from '../../../infrastructure/config/api-config';
import { pngBytes } from '../../../test-support/image-bytes';
