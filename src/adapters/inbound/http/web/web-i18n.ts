  ...
  en: {
    ...
    policy: {
      ...
      sections: [
        ...
        {
          heading: 'Contact',
          content: 'For privacy-related questions, contact us at contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Puedes solicitar la eliminación de tu cuenta y todos los datos asociados en cualquier momento enviando un correo a contact@bpt.crptmax.com. Procesaremos tu solicitud en un plazo de 30 días.',
        },
        {
        ...
        {
          heading: 'Contacto',
          content: 'Para consultas relacionadas con la privacidad, contáctanos en contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Vous pouvez demander la suppression de votre compte et de toutes les données associées à tout moment en écrivant à contact@bpt.crptmax.com. Nous traiterons votre demande dans un délai de 30 jours.',
        },
        {
        ...
        {
          heading: 'Contact',
          content: 'Pour toute question relative à la confidentialité, contactez-nous à contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Você pode solicitar a exclusão de sua conta e de todos os dados associados a qualquer momento enviando um e-mail para contact@bpt.crptmax.com. Processaremos sua solicitação em até 30 dias.',
        },
        {
          heading: 'Aviso médico',
        ...
        {
          heading: 'Contato',
          content: 'Para dúvidas relacionadas à privacidade, entre em contato pelo e-mail contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Puoi richiedere la cancellazione del tuo account e di tutti i dati associati in qualsiasi momento inviando una e-mail a contact@bpt.crptmax.com. Elaboreremo la tua richiesta entro 30 giorni.',
        },
        {
        ...
        {
          heading: 'Contatti',
          content: 'Per domande relative alla privacy, contattaci all\'indirizzo contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Du kan begära radering av ditt konto och alla tillhörande uppgifter när som helst genom att skicka e-post till contact@bpt.crptmax.com. Vi behandlar din begäran inom 30 dagar.',
        },
        {
        ...
        {
          heading: 'Kontakt',
          content: 'För integritetsrelaterade frågor, kontakta oss på contact@bpt.crptmax.com.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Вы можете в любое время запросить удаление аккаунта и всех связанных данных, написав на contact@bpt.crptmax.com. Мы обработаем ваш запрос в течение 30 дней.',
        },
        {
        ...
        {
          heading: 'Контакты',
          content: 'По вопросам конфиденциальности пишите на contact@bpt.crptmax.com.',
        },
      ],
    },
  },
  ...
  zh: {
    ...
    policy: {
      ...
      sections: [
        ...
        {
          heading: '删除账户和数据',
          content: '您可以随时通过发送电子邮件至 contact@bpt.crptmax.com 申请删除账户及所有相关数据。我们将在 30 天内处理您的申请。',
        },
        {
          heading: '医疗免责声明',
        ...
        {
          heading: '联系方式',
          content: '如有隐私相关问题，请发送邮件至 contact@bpt.crptmax.com。',
        },
      ],
    },
  },
  ...
  ko: {
    ...
    policy: {
      ...
      sections: [
        ...
        {
          heading: '계정 및 데이터 삭제',
          content: 'contact@bpt.crptmax.com으로 이메일을 보내 언제든지 계정 및 모든 관련 데이터의 삭제를 요청할 수 있습니다. 요청은 30일 이내에 처리됩니다.',
        },
        {
          heading: '의료 면책 조항',
        ...
        {
          heading: '문의',
          content: '개인정보 관련 문의는 contact@bpt.crptmax.com으로 연락하시기 바랍니다.',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'contact@bpt.crptmax.com にメールを送ることで、いつでもアカウントおよびすべての関連データの削除を依頼できます。リクエストは30日以内に処理されます。',
        },
        {
          heading: '医療上の免責事項',
        ...
        {
          heading: 'お問い合わせ',
          content: 'プライバシーに関するご質問は contact@bpt.crptmax.com までご連絡ください。',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'คุณสามารถขอลบบัญชีและข้อมูลที่เกี่ยวข้องทั้งหมดได้ตลอดเวลาโดยส่งอีเมลมาที่ contact@bpt.crptmax.com เราจะดำเนินการตามคำขอภายใน 30 วัน',
        },
        {
        ...
        {
          heading: 'ติดต่อเรา',
          content: 'สำหรับคำถามเกี่ยวกับความเป็นส่วนตัว ติดต่อเราได้ที่ contact@bpt.crptmax.com',
        },
      ],
    },
  },
    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: 'Bạn có thể yêu cầu xóa tài khoản và toàn bộ dữ liệu liên quan bất kỳ lúc nào bằng cách gửi email đến contact@bpt.crptmax.com. Chúng tôi sẽ xử lý yêu cầu của bạn trong vòng 30 ngày.',
        },
        {
        ...
        {
          heading: 'Liên hệ',
          content: 'Với các câu hỏi liên quan đến quyền riêng tư, vui lòng liên hệ với chúng tôi tại contact@bpt.crptmax.com.',
        },
      ],
    },
  },
