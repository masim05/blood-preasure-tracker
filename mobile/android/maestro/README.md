...
These flows cover the happy paths for US1 through US6. They use stable Android resource IDs rather than visible text selectors so localized strings can change without breaking the flows.
