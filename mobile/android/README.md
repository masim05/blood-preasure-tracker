# AI Blood Pressure Tracker Android

Android Studio project for the AI Blood Pressure Tracker mobile app. The UI uses Jetpack Compose Material 3 for the combined Login/New Account screen, guide, camera, history, and measurement detail journey.
...
MAESTRO_CLI_NO_ANALYTICS=1 MAESTRO_DRIVER_STARTUP_TIMEOUT=300000 maestro test maestro/us4-permission-recovery.yaml
